#lang pollen
{
	...
	"colors": {
		...
		"editor.selectionHighlightBackground": "◊(eg-color 'blue1)",
		"editor.selectionHighlightBorder": "◊(eg-color 'blue1)",
		...
		"editor.findMatchHighlightBorder": "◊(eg-color 'blue2)",
		"editor.findRangeHighlightBackground": "◊(eg-color 'teal1)",
		"editor.findRangeHighlightBorder": "◊(eg-color 'teal1)",
		"editor.rangeHighlightBackground": "◊(eg-color 'bg2)",
		"editor.rangeHighlightBorder": "◊(eg-color 'blue2)",
		"editor.hoverHighlightBackground": "◊(eg-color 'blue1)",
		"editor.wordHighlightStrongBackground": "◊(eg-color 'blue1)",
		"editor.wordHighlightBackground": "◊(eg-color 'blue1)",
