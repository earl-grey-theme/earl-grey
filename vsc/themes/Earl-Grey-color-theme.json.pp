#lang pollen
{
	...
	"colors": {
		...
		// TODO: revisit these
		"editor.findMatchBackground": "◊(eg-color 'blue2)",
		"editor.findMatchBorder": "◊(eg-color 'blue4)",
		"editor.findMatchHighlightBackground": "◊(eg-color 'blue2)",
		...
		"editor.hoverHighlightBackground": "◊(eg-color 'blue2)",
		"editor.wordHighlightStrongBackground": "◊(eg-color 'blue2)",
		"editor.wordHighlightBackground": "◊(eg-color 'blue2)",
