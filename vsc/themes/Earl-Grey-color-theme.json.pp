#lang pollen
{
	...
	"colors": {
		...
		"list.inactiveSelectionBackground": "◊(eg-color 'blue2)",
		...
		// TODO: revisit these
		"editor.findMatchBackground": "◊(eg-color 'purple1)",
		"editor.findMatchBorder": "◊(eg-color 'purple6)",
		...
		"editor.rangeHighlightBackground": "◊(eg-color 'blue1)",
		"editor.rangeHighlightBorder": "◊(eg-color 'blue1)",
		...
		"editorSuggestWidget.selectedBackground": "◊(eg-color 'purple1)",
