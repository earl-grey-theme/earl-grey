#lang pollen
{
	...
	"colors": {
		...
		"editorMarkerNavigationError.background": "◊(eg-color 'red-blend-1)",
		"editorMarkerNavigationWarning.background": "◊(eg-color 'orange-blend-1)",
		"editorMarkerNavigationInfo.background": "◊(eg-color 'blue-blend-1)",
		"merge.currentHeaderBackground": "◊(eg-color 'teal-blend-1)",
		"merge.currentContentBackground": "◊(eg-color 'teal-blend-2)",
		"merge.incomingHeaderBackground": "◊(eg-color 'blue-blend-1)",
		"merge.incomingContentBackground": "◊(eg-color 'blue-blend-2)",
		...
		"editorSuggestWidget.selectedBackground": "◊(eg-color 'purple-blend-1)",
		"editorHoverWidget.foreground": "◊(eg-color 'fg)",
		"editorHoverWidget.background": "◊(eg-color 'bg2)",
		"editorHoverWidget.border": "◊(eg-color 'grey4)",
		"peekView.border": "◊(eg-color 'blue-blend-2)",
		"peekViewEditor.background": "◊(eg-color 'bg2)",
		"peekViewEditorGutter.background": "◊(eg-color 'bg2)",
		"peekViewEditor.matchHighlightBackground": "◊(eg-color 'blue-blend-1)",
		"peekViewEditor.matchHighlightBorder": "◊(eg-color 'blue-blend-1)",
		...
		"peekViewResult.matchHighlightBackground": "◊(eg-color 'purple-blend-1)",
		"peekViewResult.selectionBackground": "◊(eg-color 'grey1)",
